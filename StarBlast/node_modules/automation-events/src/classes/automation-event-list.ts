import { createExtendedExponentialRampToValueAutomationEvent } from 'automation-events/src/functions/create-extended-exponential-ramp-to-value-automation-event';
import { createExtendedLinearRampToValueAutomationEvent } from 'automation-events/src/functions/create-extended-linear-ramp-to-value-automation-event';
import { createSetValueAutomationEvent } from 'automation-events/src/functions/create-set-value-automation-event';
import { createSetValueCurveAutomationEvent } from 'automation-events/src/functions/create-set-value-curve-automation-event';
import { getEndTimeAndValueOfPreviousAutomationEvent } from 'automation-events/src/functions/get-end-time-and-value-of-previous-automation-event';
import { getEventTime } from 'automation-events/src/functions/get-event-time';
import { getExponentialRampValueAtTime } from 'automation-events/src/functions/get-exponential-ramp-value-at-time';
import { getLinearRampValueAtTime } from 'automation-events/src/functions/get-linear-ramp-value-at-time';
import { getTargetValueAtTime } from 'automation-events/src/functions/get-target-value-at-time';
import { getValueCurveValueAtTime } from 'automation-events/src/functions/get-value-curve-value-at-time';
...
import { isSetTargetAutomationEvent } from 'automation-events/src/guards/set-target-automation-event';
